...
const AddDinersScreen = () => {
  ...
  const checkIfDinerExistsInDatabase = async (username) => {
    ...
    try {
      const response = await fetch(
        `https://03ff-2603-8000-c0f0-a570-e95b-199c-a214-1fed.ngrok-free.app/users/${username}`
      );
  ...
  useEffect(() => {
    const autoCompleteDiner = async () => {
      try {
        const response = await fetch(
          `https://03ff-2603-8000-c0f0-a570-e95b-199c-a214-1fed.ngrok-free.app/additionaldiners/suggestions?input=${inputValue}`
        );
        const data = await response.json();
        setSuggestions(
  ...
  const postData = async () => {
    ...
    try {
      const response = await fetch(
        `https://03ff-2603-8000-c0f0-a570-e95b-199c-a214-1fed.ngrok-free.app/additionaldiners`,
        {
          method: "POST",
