...
const AddDinersScreen = () => {
  ...
  const checkIfDinerExistsInDatabase = async (username) => {
    ...
    try {
      const response = await fetch(
        `https://a7cc-2603-8000-c0f0-a570-7463-3fd7-9c59-ccb5.ngrok-free.app/users/${username}`
      );
  ...
  useEffect(() => {
    const autoCompleteDiner = async () => {
      try {
        const response = await fetch(
          `https://a7cc-2603-8000-c0f0-a570-7463-3fd7-9c59-ccb5.ngrok-free.app/additionaldiners/suggestions?input=${inputValue}`
        );
        const data = await response.json();
        setSuggestions(
  ...
  const postData = async () => {
    ...
    try {
      const response = await fetch(
        `https://a7cc-2603-8000-c0f0-a570-7463-3fd7-9c59-ccb5.ngrok-free.app/additionaldiners`,
        {
          method: "POST",
