...
const ViewUserProfile = ({ route }) => {
  ...
  const handleSaveNotes = async () => {
    ...
    try {
      const response = await fetch(
        `https://d580-2603-8000-c0f0-a570-a14e-4f47-d368-7088.ngrok-free.app/savenotes`,
        {
          method: "POST",
  ...
  const fetchFavoritesStatus = async () => {
    try {
      const response = await fetch(
        `https://d580-2603-8000-c0f0-a570-a14e-4f47-d368-7088.ngrok-free.app/getfavoritestatus?userId=${userId}&favoriteDinerUsername=${favoriteDinerUsername}`
      );
      const data = await response.json();
