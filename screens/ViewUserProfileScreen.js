...
const ViewUserProfile = ({ route }) => {
  ...
  const handleSaveNotes = async () => {
    ...
    try {
      const response = await fetch(
        `https://4b35-2603-8000-c0f0-a570-d59a-2761-e0d-b64.ngrok-free.app/savenotes`,
        {
          method: "POST",
  ...
  const fetchFavoritesStatus = async () => {
    try {
      const response = await fetch(
        `https://4b35-2603-8000-c0f0-a570-d59a-2761-e0d-b64.ngrok-free.app/getfavoritestatus?userId=${userId}&favoriteDinerUsername=${favoriteDinerUsername}`
      );
      const data = await response.json();
