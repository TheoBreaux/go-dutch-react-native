...
const AddDiners = () => {
  ...
  const checkIfDinerExistsInDatabase = async (username) => {
    ...
    try {
      const response = await fetch(
        `https://143f-2603-8000-c0f0-a570-6cee-6c44-f20e-afc7.ngrok-free.app/users/${username}`
      );
  ...
  useEffect(() => {
    const autoCompleteDiner = async () => {
      try {
        const response = await fetch(
          `https://143f-2603-8000-c0f0-a570-6cee-6c44-f20e-afc7.ngrok-free.app/additionaldiners/suggestions?input=${inputValue}`
        );
        const data = await response.json();
        setSuggestions(
  ...
  const postData = async () => {
    ...
    try {
      const response = await fetch(
        `https://143f-2603-8000-c0f0-a570-6cee-6c44-f20e-afc7.ngrok-free.app/additionaldiners/`,
        {
          method: "POST",
