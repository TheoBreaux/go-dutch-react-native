...
const ReceiptCapture = ({ setIsCapturingReceipt, isCapturingReceipt }) => {
  ...
  const postData = async () => {
    ...
    if (image) {
      try {
        ...
        const response = await fetch(
          "https://24b9-2603-8000-c0f0-a570-7971-f873-39b3-59e7.ngrok-free.app/diningevents/receiptimages",
          {
            method: "POST",
    ...
    try {
      const response = await fetch(
        "https://24b9-2603-8000-c0f0-a570-7971-f873-39b3-59e7.ngrok-free.app/diningevents",
        {
          method: "POST",
          headers: {
