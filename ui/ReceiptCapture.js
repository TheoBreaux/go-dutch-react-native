...
const ReceiptCapture = ({ setIsCapturingReceipt, isCapturingReceipt }) => {
  ...
  const postData = async () => {
    ...
    if (image) {
      try {
        ...
        const response = await fetch(
          "https://4707-2603-8000-c0f0-a570-5c6c-7628-a63a-291.ngrok-free.app/diningevents/receiptimages",
          {
            method: "POST",
    ...
    try {
      const response = await fetch(
        "https://4707-2603-8000-c0f0-a570-5c6c-7628-a63a-291.ngrok-free.app/diningevents",
        {
          method: "POST",
          headers: {
