...
const ReceiptCapture = ({ setIsCapturingReceipt, isCapturingReceipt }) => {
  ...
  const postData = async () => {
    ...
    if (image) {
      try {
        ...
        const response = await fetch(
          "https://83a7-2603-8000-c0f0-a570-98f5-ecae-b39a-6e07.ngrok-free.app/diningevents/receiptimages",
          {
            method: "POST",
    ...
    try {
      const response = await fetch(
        "https://83a7-2603-8000-c0f0-a570-98f5-ecae-b39a-6e07.ngrok-free.app/diningevents",
        {
          method: "POST",
          headers: {
